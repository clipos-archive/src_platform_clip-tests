...
/* Test for chroot escape through double chroot.
 * Run at a vserver root to check vserver namespace stuff.
 * Run at a chroot root to check GRKERNSEC_CHROOT_FCHDIR.
 */
#include <stdlib.h>
#include <stdio.h>
#include <errno.h>
